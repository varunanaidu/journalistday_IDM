...
class Antigen extends MY_Controller {
	...
	public function __construct()
	{
		...
		$this->order 		= ['registration_id', 'participant_name', 'dob', 'ukuran_jersey', 'category','participant_email', 'is_ambil', 'ambil_datetime'];
		$this->search 		= ['registration_id', 'participant_name', 'dob', 'ukuran_jersey', 'category','participant_email', 'is_ambil', 'ambil_datetime'];
