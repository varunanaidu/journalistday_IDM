...
<html lang="en">
<head>
	<title>Pendaftaran Heritage Run Metro 21</title>
	<meta charset="UTF-8">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" id="antigenForm" method="POST">
				...
				<div class="wrap-input100 validate-input">
					<input class="input100" type="text" name="participant_id" id="participant_id" placeholder="Registration ID">
				...
				<div class="wrap-input100 validate-input">
					<input class="input100" type="text" name="dob" id="dob" placeholder="Date of Birth">
					<span class="focus-input100"></span>
				</div>
